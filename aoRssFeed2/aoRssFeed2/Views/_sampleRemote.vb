...
Imports Contensive.Addons.aoRssFeed2.Contensive.Addons.aoRssFeed2.Controllers
Imports Contensive.Addons.aoRssFeed2.Controllers
Imports Contensive.BaseClasses
'
Namespace Contensive.Addons.aoRssFeed2.Views
    '
            ...
            Try
                ...
                Using ae As New applicationController(cp, True)
                    ...
                    If ae.packageErrorList.Count = 0 Then
                        ...
                        '
                        ' -- create sample data
                        Dim personList As List(Of aoRssFeed2.Models.PeopleModel) = Models.PeopleModel.createList(cp, "")
                        '
