...
Namespace Controllers
    ...
    Public Class cacheController
        ...
        Private cp As BaseClasses.CPBaseClass
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub New(cp As BaseClasses.CPBaseClass)
        ...
        ''' <remarks></remarks>
        Public Sub save(ByVal CP As BaseClasses.CPBaseClass, cacheName As String, cacheValue As String)
            Try
                If allowCache Then
        ...
        ''' <remarks></remarks>
        Public Sub save(ByVal CP As BaseClasses.CPBaseClass, cacheName As String, cacheObject As Object, invalidationDate As Date, invalidationTagList As List(Of String))
            Try
        ...
        ''' <remarks></remarks>
        Public Sub save(ByVal CP As BaseClasses.CPBaseClass, cacheName As String, cacheValue As String, invalidationTagCommaList As String)
            Try
                If allowCache Then
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function read(ByVal CP As BaseClasses.CPBaseClass, cacheName As String) As String
            Dim s As String = ""
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function read2(ByVal CP As BaseClasses.CPBaseClass, cacheName As String, Optional ByRef return_cacheHit As Boolean = False) As Object
        ...
        ''' <param name="cacheName"></param>
        ''' <remarks></remarks>
        Public Sub clear(ByVal CP As BaseClasses.CPBaseClass, cacheName As String)
            Try
                'NewNew(CP)
                '
        ...
        ''' <remarks></remarks>
        Public Sub clearObjectCache_Person(ByVal CP As BaseClasses.CPBaseClass, userID As Integer, clearQualifications As Boolean, clearDegrees As Boolean, clearCourses As Boolean)
            Try
        ...
        ''' <param name="CP"></param>
        ''' <remarks></remarks>
        Public Sub flushCache(ByVal CP As BaseClasses.CPBaseClass)
            Try
                invalidateAll(CP)
                CP.Cache.ClearAll()
            Catch ex As Exception
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub invalidateAll(cp As BaseClasses.CPBaseClass)
            Try
                'NewNew(CP)
                '
        ...
        ''' <remarks></remarks>
        Public Sub invalidateTag(cp As BaseClasses.CPBaseClass, ByVal tag As String)
            Try
        ...
        ''' <remarks></remarks>
        Public Sub invalidateTagList(cp As BaseClasses.CPBaseClass, ByVal tagList As List(Of String))
            Try
                If allowCache Then
