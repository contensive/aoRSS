    ...
    Public Class RefreshProcessClass
        ...
        Public Overrides Function Execute(ByVal CP As CPBaseClass) As Object
            ...
            Try
                ...
                csv = CsvObject
                ' 
                Dim RSSFeedModelList As List(Of Models.RSSAggregatorSourcesModel) = Models.RSSAggregatorSourcesModel.createList(CP, "id<>0")
                If (RSSFeedModelList.Count <> 0) Then
                    For Each RSSFeedxml In RSSFeedModelList


                        'Dim RSSFeed As Models.RSSAggregatorSourcesModel = RSSFeedModelList.First
                                    ...
                                    For Each RootNode In .ChildNodes
                                        Select Case LCase(RootNode.Name)
                                            Case "entry"
                                                ...
                                                Dim RSSAggregatorSourceStoryList As List(Of Models.RSSAggregatorSourceStorieModel) = RSSAggregatorSourceStorieModel.createList(CP, "(itemGuid=" & CP.Db.EncodeSQLText(itemGuid) & ")and(sourceId=" & sourceId & "))")
                                                ...
                                                If (RSSAggregatorSourceStoryList Is Nothing) Then
                                                    Dim SourceStory = Models.RSSAggregatorSourceStorieModel.add(CP)
                                                ...
                                                If (RSSAggregatorSourceStoryList IsNot Nothing) Then
                                                    Dim SourceStory As Models.RSSAggregatorSourceStorieModel = RSSAggregatorSourceStoryList.First
                                                    ...
                                                    Select Case LCase(ChannelNode.Name)
                                                        Case "item"
                                                            ...
                                                            If itemGuid = "" Then
                                                                itemGuid = ItemTitle
                                                            End If
                                                            Dim RSSAggregatorSourceStoryList As List(Of Models.RSSAggregatorSourceStorieModel) = RSSAggregatorSourceStorieModel.createList(CP, "(name=" & CP.Db.EncodeSQLText(ItemTitle) & ")and(sourceId=" & sourceId & ")")
