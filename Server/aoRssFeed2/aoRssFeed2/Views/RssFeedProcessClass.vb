    ...
    Public Class RssFeedProcessClass
        ...
        Overrides Function Execute(ByVal CP As CPBaseClass) As Object
            ...
            Try
                ...
                For Each dbFeed As RSSFeedModel In RSSFeedModel.createList(CP, "")
                ...
                For Each manyToManyField In manyToManyFieldList
                    ...
                    Dim storyContent As ContentModel = ContentModel.create(CP, manyToManyField.ContentID)
                    If (storyContent IsNot Nothing) Then
                        Dim manyToManyRuleContent As ContentModel = ContentModel.create(CP, manyToManyField.ManyToManyRuleContentID)
