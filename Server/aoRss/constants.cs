...
namespace Contensive.Addons.Rss {
    public static class Constants {
        ...
        //
        public const string CoreCollectionGuid = "{8DAABAE6-8E45-4CEE-A42C-B02D180E799B}";
        public const string ApplicationCollectionGuid = "{C58A76E2-248B-4DE8-BF9C-849A960F79C6}";
        //
        ...
        public const string cr = vbCrLf + vbTab;
        public const string cr2 = cr + vbTab;
        public const string cr3 = cr2 + vbTab;
        public const string cr4 = cr3 + vbTab;
        public const string cr5 = cr4 + vbTab;
        public const string cr6 = cr5 + vbTab;
        //
        public const string AddonOptionConstructor_BlockNoAjax = "Wrapper=[Default:0|None:-1|ListID(Wrappers)]" + vbCrLf + "css Container id" + vbCrLf + "css Container class";
        public const string AddonOptionConstructor_Block = "Wrapper=[Default:0|None:-1|ListID(Wrappers)]" + vbCrLf + "As Ajax=[If Add-on is Ajax:0|Yes:1]" + vbCrLf + "css Container id" + vbCrLf + "css Container class";
        public const string AddonOptionConstructor_Inline = "As Ajax=[If Add-on is Ajax:0|Yes:1]" + vbCrLf + "css Container id" + vbCrLf + "css Container class";
        //
        ...
        //
        private const int RMBPositionLength = 0;
        private const int RMBPositionSourceHandle = 4;
        private const int RMBPositionMethod = 8;
        private const int RMBPositionArgumentCount = 12;
        private const int RMBPositionFirstArgument = 16;
        //
        ...
        //
        public const int FieldTypeInteger = 1;
        public const int FieldTypeText = 2;
        public const int FieldTypeLongText = 3;
        public const int FieldTypeBoolean = 4;
        public const int FieldTypeDate = 5;
        public const int FieldTypeFile = 6;
        public const int FieldTypeLookup = 7;
        public const int FieldTypeRedirect = 8;
        public const int FieldTypeCurrency = 9;
        public const int FieldTypeTextFile = 10;
        public const int FieldTypeImage = 11;
        public const int FieldTypeFloat = 12;
        public const int FieldTypeAutoIncrement = 13;
        public const int FieldTypeManyToMany = 14;
        public const int FieldTypeMemberSelect = 15;
        public const int FieldTypeCSSFile = 16;
        public const int FieldTypeXMLFile = 17;
        public const int FieldTypeJavascriptFile = 18;
        public const int FieldTypeLink = 19;
        public const int FieldTypeResourceLink = 20;
        public const int FieldTypeHTML = 21;
        public const int FieldTypeHTMLFile = 22;
        ...
        //
        public const int PayTypeCreditCardOnline = 0;
        public const int PayTypeCreditCardByPhone = 1;
        public const int PayTypeCreditCardByFax = 9;
        public const int PayTypeCHECK = 2;
        public const int PayTypeCREDIT = 3;
        public const int PayTypeNONE = 4;
        public const int PayTypeCHECKCOMPANY = 5;
        ...
        //
        public const int CCTYPEVISA = 0;
        public const int CCTYPEMC = 1;
        public const int CCTYPEAMEX = 2;
        public const int CCTYPEDISCOVER = 3;
        public const int CCTYPENOVUS = 4;
        public const int CCTYPEDEFAULT = 0;
        //
        public const int SHIPGROUND = 0;
        public const int SHIPOVERNIGHT = 1;
        public const int SHIPSTANDARD = 2;
        public const int SHIPOVERSEAS = 3;
        public const int SHIPCANADA = 4;
        ...
        //
        public const int AdminMenuModeHidden = 0;
        public const int AdminMenuModeLeft = 1;
        public const int AdminMenuModeTop = 2;
        //
        public const int AdminActionNop = 0;
        public const int AdminActionDelete = 4;
        public const int AdminActionFind = 5;
        public const int AdminActionDeleteFilex = 6;
        public const int AdminActionUpload = 7;
        public const int AdminActionSaveNormal = 3;
        public const int AdminActionSaveEmail = 8;
        public const int AdminActionSaveMember = 11;
        public const int AdminActionSaveSystem = 12;
        public const int AdminActionSavePaths = 13;
        ...
        public const int AdminActionSaveField = 18;
        public const int AdminActionPublish = 19;
        public const int AdminActionAbortEdit = 20;
        public const int AdminActionPublishSubmit = 21;
        public const int AdminActionPublishApprove = 22;
        public const int AdminActionWorkflowPublishApproved = 23;
        public const int AdminActionSetHTMLEdit = 24;
        public const int AdminActionSetTextEdit = 25;
        public const int AdminActionSave = 26;
        public const int AdminActionActivateEmail = 27;
        public const int AdminActionDeactivateEmail = 28;
        public const int AdminActionDuplicate = 29;
        public const int AdminActionDeleteRows = 30;
        public const int AdminActionSaveAddNew = 31;
        public const int AdminActionReloadCDef = 32;
        public const int AdminActionWorkflowPublishSelected = 33;
        public const int AdminActionMarkReviewed = 34;
        public const int AdminActionEditRefresh = 35;
        //
        public const int AdminFormRoot = 0;
        public const int AdminFormIndex = 1;
        public const int AdminFormHelp = 2;
        public const int AdminFormUpload = 3;
        public const int AdminFormEdit = 4;
        public const int AdminFormEditSystem = 5;
        public const int AdminFormEditNormal = 6;
        public const int AdminFormEditEmail = 7;
        public const int AdminFormEditMember = 8;
        public const int AdminFormEditPaths = 9;
        public const int AdminFormClose = 10;
        public const int AdminFormReports = 12;
        public const int AdminFormEditContent = 14;
        public const int AdminFormDHTMLEdit = 15;
        public const int AdminFormEditPageContent = 16;
        public const int AdminFormPublishing = 17;
        public const int AdminFormQuickStats = 18;
        public const int AdminFormResourceLibrary = 19;
        public const int AdminFormEDGControl = 20;
        public const int AdminFormSpiderControl = 21;
        public const int AdminFormContentChildTool = 22;
        public const int AdminformPageContentMap = 23;
        public const int AdminformHousekeepingControl = 24;
        ...
        //
        public const int AdminFormTools = 11;
        public const int AdminFormToolRoot = 11;
        ...
        //
        public const int IndexColumnField = 0;
        public const int IndexColumnWIDTH = 1;
        public const int IndexColumnSORTPRIORITY = 2;
        public const int IndexColumnSORTDIRECTION = 3;
        public const int IndexColumnSATTRIBUTEMAX = 3;
        ...
        public const int DataSourceTypeXMLFile = 4;
        //
        ...
        public const int ApplicationStatusKernelFailure = 6;
        public const int ApplicationStatusNoHostService = 7;
        public const int ApplicationStatusLicenseFailure = 8;
        public const int ApplicationStatusDbFailure = 9;
        public const int ApplicationStatusUnknownFailure = 10;
        public const int ApplicationStatusDbBad = 11;
        public const int ApplicationStatusConnectionObjectFailure = 12;
        public const int ApplicationStatusConnectionStringFailure = 13;
        public const int ApplicationStatusDataSourceFailure = 14;
        public const int ApplicationStatusDuplicateDomains = 15;
        public const int ApplicationStatusPaused = 16;
        //
        public const int ResponseHeaderCountMax = 20;
        public const int ResponseCookieCountMax = 20;
        //
        public const string EmailTextHTMLDelimiter = vbCrLf + " ----- End Text Begin HTML -----" + vbCrLf;
        //
        ...
        public const string RequestNameTestHook = "CC";
